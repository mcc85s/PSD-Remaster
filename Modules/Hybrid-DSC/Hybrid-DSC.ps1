        ...
        Process
        {
            ...
            If ( $Action )
            {
                ...
                $Echo | % { $_.ST = 0..4 ; $_.FG = 0..4 ; $_.BG = 0..4 
                    ...
                    $_.ST[1] = @( " /" ; $F ; "/$( $M0[98])\" , "\___  " )                  ; $_.FG[1] = 0 , 1 , 0 , 1 , 0 ;         $_.BG[1] = @( 3 ) * 5
            ...
            If ( $Free )
            {
                $Flag = [ PSCustomObject ]@{ D = ( "m" , "d" , "Y" | % { Get-Date -UFormat "%$_" } | % { "$( $_.ToCharArray() )" } ) -join ' / ' ; A = " //¯" , " \\" , " //" , " \\_" ; 
                E = "[=]" , "\_/" , "| |" ; B = ( "[=]" , "\_/" )[ 0 , 1 , 0 ] -join '' ; S = "Beginning the fight against Technological Tyranny and Cyber Criminal Activities" , 
                ...
                $Filter = @{ X = @( 0 , 1 , 2 , 3 ; @( 4 , 4 , 5 , 6 ) * 3 ; 4 , 4 , 7 ; @( 8 ) * 11 ; 9 , 2 , 1 , 0 ) ; Y = @{ 0 = 0 ; 1 = 2 ; 2 = 5 ; 3 = 4 ; 4 = @( 4 ) * 4 ; 
                5 = 4 , 4 , 5 , 4 ; 6 = 4 , 4 , 5 , 7 , 5 , 4 ; 7 = 4 , 5 , 4 ; 8 = 4 , 5 , 8 , 5 , 4 ; 9 = 4 , 8 , 4 } ; Z = @( 0 , 1 , 0 ) }
