...
#\\__//¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯\\__//¯¯\\__//¯¯\\__//¯¯\\
    ...
    { #__________________________________________________________________________________________________________________//¯¯\\__//¯¯\\__//¯¯\\__//¯¯\\
        ...
        " //         \\           [=]                                                           [=]          //           \\ " ; #\__//¯¯\\__//¯¯\\__//
        " \\         // _-=-_-=-_-[=]- 0 8 / 0 3 / 2 0 1 9  |  M I C H A E L  C  C O O K  S R  -[=]-_-=-_-=- \\           // " ; #/¯¯\\__//¯¯\\__//¯¯\\
        " //         \\           [=]  ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯  [=]          //           \\ " ; #\__//¯¯\\__//¯¯\\__//
...
#\\__//¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯\\__//¯¯\\__//¯¯\\__//¯¯\\__//¯¯\\__//¯¯\\__//¯¯\\__//¯¯\\__//¯¯\\__//
    ...
    {
        "HKLM:\SOFTWARE\Microsoft\Deployment 4" | % { ( ( GP $_ ).Install_Dir ).TrimEnd( '\' ) } `
        | % { IPMO "$_\bin\$( ( Split-Path $_ -Leaf ).Replace( ' ' , '' ) ).psd1" }
        If ( $? -eq $True ) { Return "Successful [+] MDT Module Loaded" }
        Else                { Return "Exception  [!] MDT Module Failed to load" }
    }
...
"@
        ...
        {   $SP       = $GUI.dc2.SecurePassword 
            ...
            $SitePath = "$( $GUI.r0.Text.TrimEnd( '\' ) )\$( ( $GUI.r1.Text ) )\$( $GUI.p0.Text )\$( $GUI.iis0.Text )"

            $GUI | % { 
            
                $DSCShare = [ Ordered ]@{
                        R00_Company     =                                                        "$( $_.p0.Text )" 
                        R01_UNCRoot     =                                 "\\$SRV\$( $_.r2.Text.TrimEnd( '$' ) )$" 
                        R02_Hostname    =                                                                   "$SRV" 
                        R03_DC_User     =                                                  "$( $DCCred.Username )" 
                        R04_DC_Pass     =                                           "System.Security.SecureString" 
                        R05_WWW_Site    =                                                        "$( $_.p1.Text )" 
                        R06_Phone       =                                                        "$( $_.p2.Text )" 
                        R07_Hours       =                                                        "$( $_.p3.Text )" 
                        R08_Logo        =                                                      "$( $_.img0.Text )" 
                        R09_Background  =                                                      "$( $_.img1.Text )" 
                        R10_Branch      =                                                        "$( $_.n0.Text )" 
                        R11_Domain      =                                                                "$DOMAIN" 
                        ...
                        R16_DSC_Folder  =                     "$( $_.r0.Text.TrimEnd( '\' ) )\$( ( $_.r1.Text ) )" 
                        R17_PSDrive     =                                         "$( $_.r3.Text.TrimEnd( ':' ) )" 
                        R18_PSDrive_ID  =                                                        "$( $_.r4.Text )" 
                        R19_BITS_Name   =                                                      "$( $_.iis0.Text )" 
                        R20_BITS_Pool   =                                                      "$( $_.iis1.Text )" 
                        R21_BITS_Host   =                                                      "$( $_.iis2.Text )" 
                        R22_BITS_Root   =                                                              "$SitePath" }
             }
...
#    \\___[ Building Linked Hybrid-DSC Tool Set ]____//__\\__//__\\__//__\\__//__\\__//__\\__//__\\__//__\\__//__\\__//¯¯\\__//¯¯\\__//¯¯\\__//¯¯\\__//
            ...
            $DR = "$( $R[16] )"
            $DS = "$DR\$( $R[0] )" | % { If ( ( Test-Path $_ ) -ne $True ) { NI $_ -ItemType Directory } Else { GI $_ } }
